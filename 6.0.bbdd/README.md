...
| [Wiki](https://en.wikipedia.org/wiki/Chess) - [Youtube](https://www.youtube.com/watch?v=soEAyjaeF-w)<br/> * _Funcionalidad: **Básica + Undo/Redo**_<br/>  * _Interfaz: **Gráfica y Texto**_<br/>  * _Distribución: **Standalone + Client/Server**_<br/>  * _Persistencia: **Ficheros + Bases de Datos**_<br/> | ![chess](./docs/images/chess.jpg) | 
| :------- | :------: |  
